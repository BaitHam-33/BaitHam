...
class TestUrls(unittest.TestCase):
    ...
    def test_addInForum_url_is_resolved(self):
        ...
        self.assertEqual(url, '/forum/addInForum/')
        self.assertEqual(resolve(url).func,addInForum)
    ...
    def test_addInDiscussion_url_is_resolved(self):
        ...
        self.assertEqual(resolve(url).func,addInDiscussion)  # checks if the url pattern resolved to the right view function
